...
redline_fig <- rl2 %>%
  ggplot(aes(y = fct_rev(grade), x = (avg_temp - as.numeric(av)), fill = (avg_temp))) +
  councilR::council_theme() +
  geom_vline(xintercept = 0, color = "grey70") +
  # geom_point() +
  ggbeeswarm::geom_beeswarm(
            size = 2, #if(geo_selections$selected_geo == "ctus") {2.5} else {3}, 
            # alpha = .3,
            cex = 1.5,
  ...
  labs(x = "2016 temperature difference from region average",
       y = "1934\nHome\nOwners'\nLoan\nCorporation\nrating",
