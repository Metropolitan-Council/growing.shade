...
knitr::opts_chunk$set(echo = F, message = F, warning = F,
                      cache = TRUE,
                      cache.path = "cache/")
library(dplyr); library(tidyr); library(readr)#library(ggplot2); library(string)
library(tigris)
library(sf)
library(tidycensus)
library(ggbeeswarm)
...
Also, because this CDC data currently uses old census geographies, you will need to download a crosswalk
  - Download the state-specific crosswalk of ["Block Groups --> Census Tracts" for year "2010 --> 2020" from NHGIS](https://www.nhgis.org/geographic-crosswalks#download-from-block-groups)
