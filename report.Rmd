...
This report was generated from the Growing Shade interactive tool produced by the Metropolitan Council in collaboration with The Nature Conservancy and Tree Trust. If more or different information is needed, go to these sources or maybe email us? 

Understanding the tree canopy as well as the interaction between trees adn the built + natral environments is important for planning efforts. Something about heat. Mitigation. Tree canopy cover data can help provide that big-picture view.

This summary report provide an easy way to understand some of the important information for the selected region.
...
The selected region has an existing tree coverage of approximately X%. 
...
# What's coming next for Growing Shade?
