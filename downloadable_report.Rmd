...
```{css, echo=FALSE, include = FALSE, eval =F}
caption {
    font-size: .9em;
    font-color: #A9A9A9
}
...
```{r map, echo = FALSE, message = FALSE, warning = FALSE, fig.alt = "Outline of the Twin Cities region, the area which this report was made for is mapped in green.", fig.align="right", out.width= "43%", out.extra='style="float:right; padding:10px"'}
...
```{r priority-table, results='markup', tidy = FALSE}
knitr::kable(params$param_prioritytable,
  ...
  # kableExtra::kable_styling(full_width = FALSE) %>%
    kableExtra::kable_classic("striped", full_width = FALSE, html_font = "Cambria")# %>%
...
```{r old_threats, include = FALSE, eval = FALSE}
### Methodology note
