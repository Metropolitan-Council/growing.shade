  ...
  tagList(
    ...
    navbarPage(
      ...
      tabPanel(
        "Mapping tool",
        tags$footer(
          HTML('Source: <a href = "https://metrocouncil.org/Communities/Planning/Local-Planning-Assistance/Tree-Canopy.aspx" target = "_blank">Growing Shade Project</a>. Last updated on 2022-02-08. '),
          align = "right",
          style = "
              position:absolute;
              bottom:1em;
