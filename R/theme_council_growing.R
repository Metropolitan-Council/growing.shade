...
theme_council_growing <- function(
    ...
    font_sizes = list(
      title = 22, subtitle = 16, axis_title = 14,
  ...
  if (use_showtext == TRUE) {
    ...
    font_locs <- subset(sysfonts::font_files(), family %in%
      c(
        "HelveticaNeueLT Std Cn", "HelveticaNeueLT Std Lt",
        "Arial Narrow"
      ) & face == "Regular")
  ...
  if (use_manual_font_sizes == FALSE) {
    font_sizes <- list(
      title = ggplot2::rel(1.2), subtitle = ggplot2::rel(1.1),
  ...
  t <- ggplot2::theme(
    ...
    legend.title = ggplot2::element_text(
      hjust = 0, family = font_families$title,
