...
mod_storymap_server <- function(id) {
  moduleServer(id, function(input, output, session) {
    ...
    output$storymap <- renderUI({
      my_test <- HTML("<div style='max-width:3000px'><body><iframe src='https://storymaps.arcgis.com/stories/1a7fe9365a8f4bfc81305bb288fbbcfa' style='width:100%; margin:0 !important;padding:0;height:90vh;border:none; frameborder = '0'</iframe></body></div>")
