...
ctu_list <- ctu_list %>% st_make_valid() %>% st_simplify(dTolerance = 100)
ggplot() +
...
metc_region <- metc_region %>% st_simplify(dTolerance = 400)
# ggplot()+#geom_sf(data = metc_region) +
#   geom_sf(data = metc_region2, col = "blue", fill = NA)
