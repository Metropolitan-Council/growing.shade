...
Calib coeff is 0.7159169, meaning that senitel sees about 25% more trees; or detects area with at least 70% tree canopy coverage. Sentinel sees 1000 acres, UMN sees more like 710 acres. 
...
```{r ndvi_bgs}
bg_ndvi <- read_csv("../data-raw/TreeAcres/meanNDVI_mnwi_blockgroups_year2021.csv",
                    na = "No data",
