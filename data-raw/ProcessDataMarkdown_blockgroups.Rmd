...
bg_growingshade_data_allMN <- 
  ...
  mutate(holc_pred = if_else(is.na(holc_pred), 0, holc_pred)) %>%
    ...
    mutate(across(c(poptotal:pwk_nowork, pd_any:povdenom, env_cancer:holc_pred, CASTHMA:PHLTH, pop_density:housing_density), ~ if_else(poptotal == 0, NA_real_, .x)),
...
filter(bg_growingshade_data, bg_string == "270531044003")  
