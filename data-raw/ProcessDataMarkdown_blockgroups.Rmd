...
- get the count of EAB. **This has been removed, eab is everywhere, will kill every untreated ash tree. no longer necessary to rely on dnr maps.** 
...
eva_data_codes %>% arrange(type, name)%>% dplyr::select(type, name)
