...
bg_growingshade_data_allMN <- 
  ...
  dplyr::select(-c(pblacknh_acs:pbipoc_acs))# %>% filter(bg20 == "270531016003")
...
filter(bg_growingshade_data_allMN, bg_string %in% c("270531263002")) #this has population, but no age component
