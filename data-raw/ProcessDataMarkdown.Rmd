...
## ctu canopy ----
canopy_ctu <- read_csv("../data-raw/TreeAcres_ctus_year2020.csv",
...
## nhood canopy ----
canopy_nhood <- read_csv("../data-raw/TreeAcres_neighborhoods_year2020.csv",
  ...
  transmute(GEO_NAME = GEO_NAME, 
            ...
            landacres = ALAND / 4046.86,
            canopy_percent = treeacres / landacres * calib_coeff) %>%
  full_join(read_csv("../data-raw/UMNTreeAcres_neighborhoods_year2020_scale1.csv")) %>%
...
sf::st_write(ctu_list, "/Users/escheh/Documents/GitHub/planting.shade/storymap-info/shapefiles/ctu_list.shp", append = FALSE)
...
eva_data_codes <- tribble(~variable, ~name, ~type, ~interpret_high_value, ~cc, ~ej, ~ph, ~cons,
                          ...
                          "holc_pred", "Share of tract's land acreage redlined", "environment", "high_opportunity", 0, 1, 0, 0,
...
sf::st_write(mn_tracts, "/Users/escheh/Documents/GitHub/planting.shade/storymap-info/shapefiles/mn_tracts.shp", append = FALSE)
...
fig_equity
ggsave("/Users/escheh/Desktop/equity.png",fig_equity,  width = 10, height = 4.5, units = "in", device = "png")
