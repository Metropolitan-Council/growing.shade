...
# remote sensing data
######
regional_specific_data <- FALSE #ndvi, tree canopy cover, etc


######
# city geo
######
regional_specific_geography <- FALSE 
...
>>>>>>> further generalize code
```{r}
if (regional_specific_geography == FALSE) {
cities <- tigris::county_subdivisions(
  state = state,
  county = county,
  class = "sf"
